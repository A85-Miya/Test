                ...
                <table>
                    <tr>
                        <% for (int i = 0; i < wearList.size(); i++) { %>
                            <th>
                                <a href="<%=request.getContextPath() %>/WearDetail?id=<%=wearList.get(i).getId() %>">
                                    <%=wearList.get(i).getName() %>
                                </a>
                            </th>
                            <th>
                            ...
                            <th>
                                <a href="<%=request.getContextPath() %>/InsertCart?id=<%=wearList.get(i).getId() %>">
                                    カートに入れる
                                </a>
                            </th>
                        <% } %>
